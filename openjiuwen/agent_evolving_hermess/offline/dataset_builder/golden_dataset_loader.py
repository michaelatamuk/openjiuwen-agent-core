...
class GoldenDatasetLoader:
    ...
    Mirrors Hermess GoldenDatasetLoader exactly:
    ...
    This matches the Hermess evolution/core/dataset_builder.py implementation.
    """
    ...
    def load(path: Path) -> "EvalDataset":
        ...
        # ── Case 2: single JSONL file — auto-split (mirrors Hermess) ─────────

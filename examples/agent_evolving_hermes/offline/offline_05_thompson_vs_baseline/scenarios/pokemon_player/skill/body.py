# ══════════════════════════════════════════════════════════════════════════════
# BASELINE SKILL — the current pokemon-player skill, with the Gen 1 Quirks
# section deliberately removed so GEPA has room to evolve it.
#
# WHY this produces a LOW baseline score (~0.20–0.40)
# ────────────────────────────────────────────────────
# Hard examples test Gen 1-exclusive mechanics where the LLM's training
# data (dominated by Gen 2+ content) produces plausible but WRONG answers:
#   - Poison kills in overworld (Gen 1 only — Gen 2+ stops at 1 HP)
#   - Freeze is permanent (Gen 1 only — Gen 2+ has 20% thaw per turn)
#   - Hyper Beam no recharge on KO (Gen 1 only — Gen 2+ always recharges)
#   - Bug super-effective vs Poison (Gen 1 only — removed in Gen 2)
#   - 1/256 accuracy glitch (Gen 1 only)
#   - Badge stat boosts (Gen 1 only — each badge raises a specific stat)
#   - Special stat = combined Sp.Atk + Sp.Def (Gen 1 only — split in Gen 2)
#   - Paralysis vs Sleep for catching (nuanced Gen 1 flee-prevention mechanic)
#
# An evolved skill that explicitly documents these Gen 1-specific rules
# allows the agent to give correct answers instead of the common Gen 2+ ones.
# ══════════════════════════════════════════════════════════════════════════════
